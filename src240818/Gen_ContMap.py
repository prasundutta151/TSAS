...
if(len(sys.argv)!=EXP_NARG):
    print
    print "USAGE: python/run", sys.argv[0], "<CONTFILE> <DELIFILE> <REGFILE> <OUTPFILE> <SMSIG>"
...
FITS_WRITE(OUTPFILE, dataO, dxyO, BMajO, BMinO)
